library(pacman)
p_load(tidyverse,readxl,lubridate,conflicted,rmarkdown,knitr)
...
for(b in 1:nrow(testdata)){
  ...
  outfile <- here("~","OneDrive - Canadian Sport Institute Pacific","Tsai","CSIP","projects","CSIP","anthro","Documents - Anthropometry","reports",AthleteData$Date[1],paste0(AthleteData$AthleteName[1],"_",AthleteData$Date[1],".pdf"))
  
  suppressWarnings(suppressMessages(render(here("~","OneDrive - Canadian Sport Institute Pacific","Tsai","CSIP","projects","CSIP","anthro","code","anthro_report_mct.Rmd"),
         output_file = outfile,
